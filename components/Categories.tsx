            ...
            <div className="container-80">
                ...
                {loading ? (
                    ...
                    <div className="grid grid-cols-6 sm:grid-cols-8 md:grid-cols-10 lg:grid-cols-12 gap-3">
                        {displayCategories.slice(0, 24).map((category) => {
                            ...
                            return (
                                <Link
                                    ...
                                    className="flex flex-col items-center gap-2 p-2 hover:bg-surface transition-all group cursor-pointer"
                                >
                                    <div className="w-14 h-14 overflow-hidden bg-white shadow-sm group-hover:scale-105 transition-transform">
                                        <Image
                                            src={imagePath}
                                            alt={category.name}
                                            width={56}
