          ...
          <div className="max-w-xl z-10">
            ...
            <FadeIn delay={0.3}>
              <p className="text-gray-500 mb-8 leading-relaxed">
                Tenggelamlah dalam cerita yang bermakna. Dari klasik modern hingga permata tersembunyi, kami menghadirkan yang terbaik untuk rak buku Anda.
              </p>
            </FadeIn>
            ...
            <FadeIn delay={0.4}>
              ...
              <a href="/#products" className="bg-primary text-white px-8 py-3.5 rounded-full font-medium hover:bg-opacity-90 transition-all flex items-center gap-2 group">
                Jelajahi Buku <ArrowRight size={16} className="group-hover:translate-x-1 transition-transform" />
              </a>
