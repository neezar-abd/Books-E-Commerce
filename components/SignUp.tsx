...
const SignUp: React.FC = () => {
  ...
  const testimonials = [
    ...
    {
      quote: "Sistem reward dan diskon member sangat menguntungkan. Saya sudah menghemat jutaan rupiah sejak bergabung!",
      name: "Budi Santoso",
      role: "Pengusaha",
    ...
    <div className="min-h-screen flex">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white">
        <div className="w-full max-w-md">
          ...
          {/* Title */}
          <h1 className="text-4xl font-bold text-primary mb-2">Daftar</h1>
          <p className="text-gray-600 mb-8">Isi informasi Anda di bawah ini atau daftar dengan akun sosial.</p>
          ...
          {success && (
            <div className="p-4 bg-green-50 border-2 border-green-200 text-green-700 rounded-xl text-sm">
              Pendaftaran berhasil! Mengarahkan ke halaman verifikasi...
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:outline-none focus:border-primary transition-colors pr-12"
                  required
                />
                <button
                  type="button"
            ...
            <div className="flex items-start gap-2">
              <div
                className={`w-5 h-5 rounded border-2 flex items-center justify-center flex-shrink-0 mt-0.5 cursor-pointer transition-colors ${agreeTerms ? 'bg-primary border-primary' : 'border-gray-300'
                  }`}
              ...
              <label className="text-sm text-primary cursor-pointer" onClick={() => setAgreeTerms(!agreeTerms)}>
                Setuju dengan <Link href="/terms" className="font-bold underline">Syarat & Ketentuan</Link> dan <Link href="/privacy" className="font-bold underline">Kebijakan Privasi</Link>
              </label>
            </div>
            ...
            <p className="text-center text-sm text-gray-600 mt-6">
              Sudah punya akun? <Link href="/sign-in" className="font-bold text-primary underline hover:text-secondary">Masuk</Link>
            </p>
          </form>
        </div>
      </div>
